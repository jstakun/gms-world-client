...
public class LayerManager {
    ...
    private LayerManager() {
        ...
        allLayers.put(Commons.OSM_TAXI_LAYER, LayerFactory.getLayer(Commons.OSM_TAXI_LAYER, false, true, isLayerEnabledConf(Commons.OSM_TAXI_LAYER), false, true, Arrays.asList(new LayerReader[]{new OsmReader()}), null, R.drawable.taxi16, null, R.drawable.taxi24, LAYER_LOCAL, Locale.getMessage(R.string.Layer_OSM_Taxi_desc), Commons.OSM_TAXI_LAYER, FileManager.ClearPolicy.ONE_MONTH, R.drawable.taxi128)); 

...
public class LayerManager {
    ...
    public LayerManager() {
        ...
        allLayers.put(Commons.YOUTUBE_LAYER, LayerFactory.getLayer(Commons.YOUTUBE_LAYER, false, true, isLayerEnabledConf(Commons.YOUTUBE_LAYER), false, true, Arrays.asList(new LayerReader[]{new YouTubeReader()}), null, R.drawable.youtube_icon, null, -1, LAYER_LOCAL, Locale.getMessage(R.string.Layer_YouTube_desc), Commons.YOUTUBE_LAYER, FileManager.ClearPolicy.ONE_MONTH)); 
        allLayers.put(Commons.WEBCAM_LAYER, LayerFactory.getLayer(Commons.WEBCAM_LAYER, false, true, isLayerEnabledConf(Commons.WEBCAM_LAYER), false, true, Arrays.asList(new LayerReader[]{new WebcamReader()}), null, R.drawable.webcam, null, -1, LAYER_LOCAL, Locale.getMessage(R.string.Layer_Travel_Webcams_desc), Commons.WEBCAM_LAYER, FileManager.ClearPolicy.ONE_DAY)); 
        allLayers.put(Commons.LM_SERVER_LAYER, LayerFactory.getLayer(Commons.LM_SERVER_LAYER, false, true, isLayerEnabledConf(Commons.LM_SERVER_LAYER), true, true, Arrays.asList(new LayerReader[]{new GMSWorldReader()}), null, R.drawable.globe16_new, null, R.drawable.globe24_new, LAYER_LOCAL, Locale.getMessage(R.string.Layer_Public_desc, ConfigurationManager.GMS_WORLD), Commons.LM_SERVER_LAYER, FileManager.ClearPolicy.ONE_MONTH)); 
        allLayers.put(Commons.LOCAL_LAYER, LayerFactory.getLayer(Commons.LOCAL_LAYER, false, true, isLayerEnabledConf(Commons.LOCAL_LAYER), false, false, null, null, R.drawable.star, null, -1, LAYER_LOCAL, Locale.getMessage(R.string.Layer_Phone_Landmarks_desc), Commons.LOCAL_LAYER, FileManager.ClearPolicy.ONE_MONTH)); 
        allLayers.put(Commons.ROUTES_LAYER, LayerFactory.getLayer(Commons.ROUTES_LAYER, false, true, isLayerEnabledConf(Commons.ROUTES_LAYER), false, false, null, null, R.drawable.route, null, R.drawable.start_marker, LAYER_LOCAL, Locale.getMessage(R.string.Layer_Routes_desc), Commons.ROUTES_LAYER, FileManager.ClearPolicy.ONE_MONTH));
        allLayers.put(Commons.MY_POSITION_LAYER, LayerFactory.getLayer(Commons.MY_POSITION_LAYER, false, true, isLayerEnabledConf(Commons.MY_POSITION_LAYER), false, false, null, null, R.drawable.mypos16, null, R.drawable.ic_maps_indicator_current_position, LAYER_LOCAL, null, Commons.MY_POSITION_LAYER, FileManager.ClearPolicy.ONE_MONTH));
    }
    ...
    protected void addLayer(String name, boolean extensible, boolean manageable, boolean enabled, boolean checkinable, boolean searchable, String smallIconPath, String largeIconPath, String desc, String formatted) {
        synchronized (layers) {
            if (smallIconPath == null) {
                layers.put(name, LayerFactory.getLayer(name, extensible, manageable, enabled, checkinable, searchable, null, null, R.drawable.custom, null, -1, LAYER_LOCAL, desc, formatted, FileManager.ClearPolicy.ONE_MONTH));
            } else {
                layers.put(name, LayerFactory.getLayer(name, extensible, manageable, enabled, checkinable, searchable, null, smallIconPath, -1, largeIconPath, -1, LAYER_FILESYSTEM, desc, formatted, FileManager.ClearPolicy.ONE_MONTH));
            }
        }
    }
    ...
    private void initializeDynamicLayers() {
        ...
        if (StringUtils.isNotEmpty(dl)) {
            ...
            for (int i = 0; i < dynamicLayersStr.length; i++) {
                ...
                Layer newLayer = LayerFactory.getLayer(layer, false, false, true, false, true, null, null, res, null, -1, LAYER_DYNAMIC, null, StringUtils.capitalize(layer), FileManager.ClearPolicy.ONE_MONTH);
    ...
    public boolean addDynamicLayer(String keywords) {
        ...
        if (!containsLayer) {
            ...
            Layer layer = LayerFactory.getLayer(layerName, false, false, true, false, true, null, null, res, null, -1, LAYER_DYNAMIC, null, StringUtils.capitalize(layerName), FileManager.ClearPolicy.ONE_MONTH);

        ...
        if (shadow == false) {
            ...
            if (text == null) {
            	...
            	if (mapView.getZoomLevel() > 1) {               
                    ...
                    //distance = DistanceUtils.distanceInMeter(MathUtils.coordIntToDouble(p1.getLatitudeE6()),
                    //		MathUtils.coordIntToDouble(p1.getLongitudeE6()),
                    //		MathUtils.coordIntToDouble(p2.getLatitudeE6()),
                    //		MathUtils.coordIntToDouble(p2.getLongitudeE6()));
                }
                text = DistanceUtils.formatDistance(distance);
                //text = DistanceUtils.formatDistanceInMeters((int)distance);
